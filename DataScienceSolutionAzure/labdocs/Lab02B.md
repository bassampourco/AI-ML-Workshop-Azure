...
[![Watch the video](https://amlworkshop.blob.core.windows.net/mlworkshop/7-Deploy-Designer.png)](https://amlworkshop.blob.core.windows.net/mlworkshop/7-Deploy-Designer.mp4)
...
4. In Jupyter, in the **Users/AI-ML-Workshop-Azure/DataSienceSolutionAzure** folder, open **02B - Using the Visual Designer.ipynb**.
